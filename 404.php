...
<section class="frogbid-title">
    <h1 class="text-center frogbid-work-title text-white">Oops!</h1>
</section>
<!-- Title End -->
...
<section class="frogbid-web">
    <div class="container pt-5 pb-5 text-center">
        <h1 class="frogbid-work-title text-start pt-5 pb-4 text-center">
            <span class="frogbid-hebrew">404</span>
        </h1>
            ...
            <div class="col-xl-12 mb-4">
                <div class="row">
                    <div class="col-12 mb-5 text-center">
                        ...
                        <a class="btn btn-success frogbid-btn-footer mt-3" href="Home">
